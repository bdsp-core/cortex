// Results screen — per-task determination/classification table. The aggregate
// roll-up is deliberately NOT a single pass/fail: certification remains
// domain-specific downstream reporting.
...
export function Results({ summary, onFinish, onReturn }: {
  ...
  // then the actions fade in as the footer.
