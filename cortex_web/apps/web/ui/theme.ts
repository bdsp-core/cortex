...
export const VERDICT_STYLE: Record<string, { color: string; label: string }> = {
  ...
  ABOVE_CUT: { color: COLORS.pass, label: "AT EXPERT" },
  BELOW_CUT: { color: COLORS.fail, label: "BELOW EXPERT" },
  INDETERMINATE_AT_CUT: { color: COLORS.referBorderline, label: "INDETERMINATE" },
