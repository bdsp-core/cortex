...
// Frozen integrated standard selected in the isolated n-way protocol. The
// nine draws are mixed at the response-probability level; the weighted mean
// is used only by the cheap Fisher shortlist screen.
export const NWAY_ARTIFACT = Object.freeze({
  ...
  // Honest provenance: the owner explicitly approved this simulation-proven
  // integrated profile as the production standard on 2026-07-20. DR07 was not
  // separately qualified; do not relabel that research result.
  approval: "owner_approved_simulation_standard_2026-07-20",
